...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('account', '0004_resetpasswordcode'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alias', models.CharField(blank=True, max_length=32, null=True, unique=True, verbose_name='URL别名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ManyToManyField(related_name='roles', to='account.UserInfo', verbose_name='用户')),
            ],
            options={
                'verbose_name': '角色表',
